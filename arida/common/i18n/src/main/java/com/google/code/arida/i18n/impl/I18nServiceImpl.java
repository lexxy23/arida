...
public class I18nServiceImpl implements I18nService {
	 ...
	 */
	@Override
	public String getTranslation(String titleKey, String fileBaseName, Locale l) {
		return getTranslation(titleKey, fileBaseName, l, "");
	}

	@Override
	public String getTranslation(String titleKey, String fileBaseName,
			Locale l, String defValue) {
